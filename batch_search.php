            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    ...
                    <div class="card mt-12">
                        ...
                        <h4>Search Student Data by Student Batch</h4>
                    </div>
                        <div class="card-body">
                            ...
                            <form action="" method="GET">
                                <div class="row">
                                    <div class="col-md-8">
                                        <input type="text" name="AdmissionYear" value="<?php if (isset($_GET['AdmissionYear'])) { echo $_GET['AdmissionYear'];  } ?>" class="form-control" placeholder="Search student by Batch...">
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    if (isset($_GET['AdmissionYear'])) {
                                        ...
                                        $query = "SELECT * FROM student_data WHERE AdmissionYear='$AdmissionYear' ";
