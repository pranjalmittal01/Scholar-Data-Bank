            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    ...
                    <div class="card mt-12">
                        ...
                        <h4>Search Student Data by Student Name</h4>
                    </div>
                        <div class="card-body">
                            ...
                            <form action="" method="GET">
                                <div class="row">
                                    <div class="col-md-8">
                                        <input type="text" name="FullName" value="<?php if (isset($_GET['FullName'])) { echo $_GET['FullName'];  } ?>" class="form-control" placeholder="Search student by Name...">
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    if (isset($_GET['FullName'])) {
                                        ...
                                        $query = "SELECT * FROM student_data WHERE FullName='$FullName' ";
