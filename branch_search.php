            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    ...
                    <div class="card mt-12">
                        ...
                        <h4>Search Student Data by Student Branch</h4>
                    </div>
                        <div class="card-body">
                            ...
                            <form action="" method="GET">
                                <div class="row">
                                    <div class="col-md-8">
                                        <input type="text" name="Branch" value="<?php if (isset($_GET['Branch'])) {
                                        echo $_GET['Branch']; } ?>" class="form-control" placeholder="Search student by Branch...">
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    if (isset($_GET['Branch'])) {
                                        ...
                                        $query = "SELECT * FROM student_data WHERE Branch='$Branch' ";
