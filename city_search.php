            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    ...
                    <div class="card mt-12">
                        ...
                        <h4>Search Student Data by Student City</h4>
                    </div>
                        <div class="card-body">
                            ...
                            <form action="" method="GET">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        echo $_GET['City']; } ?>" class="form-control" placeholder="Search student by City...">
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    if (isset($_GET['City'])) {
                                        ...
                                        $query = "SELECT * FROM student_data WHERE City='$City' ";
